...
var resizePizzas = function(size) { 
  ...
  // if (document.querySelector("#pizzaSize").innerHTML = "Small"){
    
  // }
  // else if (document.querySelector("#pizzaSize").innerHTML = "Medium"){

  // }
  // else if (document.querySelector("#pizzaSize").innerHTML = "Large"){
  ...
  function changePizzaSizes(size) {
      ...
      // As the dimension of each block is the same the calculation has to be done only once
      // Afterwards to avoid querying each time in the for loop we put pizzacontainer into an array
...
// This is implemented in order to prevent firing multiple animation frames at the same time. 
...
// Translate Z 0 to force hardware acceleration on mobile
  var items = document.querySelectorAll('.mover');
  var scrollval=window.scrollY;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin((scrollval / 1250) + (i%5));
